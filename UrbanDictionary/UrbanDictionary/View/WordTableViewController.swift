...
class WordTableViewController: UITableViewController {
    ...
    */
    ...
    private func loadWords() {
        let word1 = Word(definition: "Definition1", thumbs_up: 10, thumbs_down: 1)
        let word2 = Word(definition: "Definition2", thumbs_up: 7, thumbs_down: 6)
        let word3 = Word(definition: "Definition3", thumbs_up: 2, thumbs_down: 10)
